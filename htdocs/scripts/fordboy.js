		...
		function clock()
		  {
			 ...
			 for(i=0;i<total;i++){
				   ...
				   $("#btt span").eq(i).css("background","#f3f3f3");
				   $(cname).css("display","none");
			 }
			 
		  cname="#solid .solid" + now;
		  $("#solid ul li").eq(now).fadeIn(400);
		  $("#btt span").eq(now).css("background","#116da9");
		  $(cname).css("display","block");
		  }
	 $(document).ready(function() {
		$("#solid ul li").eq(0).fadeIn(400);
		$("#btt span").eq(0).css("background","#116da9");
		...
		$("#btt span").eq(1).css("margin-left","20px");
		$("#btt span").eq(2).css("margin-left","40px");
		});